    ...
    public partial class UpdatedTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InterestID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Interest = table.Column<string>(unicode: false, maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPictures", x => x.PictureID);
                    table.ForeignKey(
                        name: "FK_UserPicture_IntegratorFiles",
                        column: x => x.FilesID,
                        principalTable: "IntegratorFiles",
                        principalColumn: "FileID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Interests",
                columns: new[] { "InterestID", "Interest" },
                values: new object[,]
                {
                    { 1, "Climbing" },
                    { 2, "Snowboarding" },
