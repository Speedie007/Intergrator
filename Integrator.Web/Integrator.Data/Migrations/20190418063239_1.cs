        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyRelatedIndustries_Company",
                        column: x => x.CompanyID,
                        principalTable: "Companies",
                        principalColumn: "CompanyID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComanyJobRelatedIndustries_CoreKbIndustries",
                        column: x => x.CoreKbIndustryID,
                        principalTable: "CoreKbIndustries",
                        principalColumn: "CoreKbIndustryID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserJobID = table.Column<int>(nullable: false),
                    CoreKbIndustryID = table.Column<int>(nullable: false),
                    LevelOfIndustInvolvement = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyJobRelatedIndustries_CoreKbIndustryID",
                table: "CompanyJobRelatedIndustries",
