...
{
    public partial class IntegratorEntityTypeConfiguration<TEntity> : IMappingConfiguration, IBaseEntity, IEntityTypeConfiguration<TEntity> where TEntity : BaseEntity
    {
        #region Utilities
