...
namespace Integrator.Common.Configuration
{
    public class AppDomainTypeFinder : ITypeFinder
    {
        #region Fields

        protected IIntegratorFileProvider _fileProvider;
        ...
        public AppDomainTypeFinder(IIntegratorFileProvider fileProvider = null)
        {
