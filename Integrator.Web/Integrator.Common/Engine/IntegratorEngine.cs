...
using Integrator.Common.Mapper;
...
namespace Integrator.Common.Engine
{
    class IntegratorEngine : IEngine
    {
        #region Properties
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            CommonHelper.DefaultFileProvider = new IntegratorFileProvider(hostingEnvironment);
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new IntegratorException("Unknown dependency");
                        return service;
                    });
            ...
            throw new IntegratorException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
